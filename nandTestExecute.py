...
class Repeater:
    def __init__(self):
        time0 = datetime.datetime(2017, 7, 26, 17, 23, 50, 78915)
        time1 = datetime.datetime(2017, 7, 26, 19, 16, 00, 78915)
        time2 = datetime.datetime(2017, 7, 26, 21, 16, 10, 78915)
        time3 = datetime.datetime(2017, 7, 26, 23, 16, 20, 78915)
        ...
        self.times = [time0, time1, time2, time3, time4, time5, time6, time7]
